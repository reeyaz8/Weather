...
class Home extends StatelessWidget {
  List<String> _day = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
  @override
    ...
    final weatherdata = Provider.of<WeatherData>(context);
      ...
      appBar: weatherdata.dataRenderComplete == false ? null : PreferredSize(child: AppBar(
        ...
        builder: (context, snapshot){
          return Column(
            children: <Widget>[
              Text(DateTime.now().toLocal().toString().split('.')[0]+'   '+_day[DateTime.now().weekday], style: TextStyle(color: Colors.black, fontSize:16.0),),
            ],
          );
        }),
        SizedBox(height:5.0)
                    ...
                    child: Column(
                      ...
                      Row(
                        ...
                        Column(children: <Widget>[
                          FittedBox(child: Text(weatherdata.forecast[0]['day']['maxtemp_c'].toString(), style: TextStyle(color: Colors.black, fontSize: 35.0),)),
                          Container(
                            width: 50.0,
                            child: Divider(height: 20.0 , thickness: 2.0,color: Colors.black,)),
                          FittedBox(child: Text(weatherdata.forecast[0]['day']['mintemp_c'].toString(), style: TextStyle(color: Colors.black, fontSize: 35.0),)),
                        ],),
                        SizedBox(width: 20.0),
                          ...
                          child: Row(
                            ...
                            SizedBox(width: 40.0,),
                             Column(
                              ...
                              SizedBox(height:10.0),
                              Text(weatherdata.forecast[0]['astro']['sunrise'], style: TextStyle(fontSize:25.0),)
                            ],)
                          ],),
                        )),
                      SizedBox(height:10.0),
                          ...
                          child: Row(
                            ...
                            SizedBox(width: 40.0,),
                             Column(
                              ...
                              SizedBox(height:10.0),
                              Text(weatherdata.forecast[0]['astro']['sunset'], style: TextStyle(fontSize:25.0),)
                            ],)
                          ],),
                        ),
                         ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text('Chance of Rain'),
                          SizedBox(height:10.0),
                          Text(weatherdata.forecast[0]['day']['daily_chance_of_rain'].toString()+' %', style: TextStyle(fontSize: 25.0),)
                        ],
                      ),),
                    SizedBox(width:15.0),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text('Humidity'),
                          SizedBox(height:10.0),
                          Text(weatherdata.current['humidity'].toString()+' %', style: TextStyle(fontSize: 25.0),)
                        ],
                      ),),
                    SizedBox(width:15.0),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text('Precipitation'),
                          SizedBox(height:10.0),
                          Text(weatherdata.current['precip_mm'].toString()+' mm', style: TextStyle(fontSize: 25.0),)
                        ],
                      ),
                      ),
                  ],),
